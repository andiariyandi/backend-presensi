...
module.exports = {
    ...
    listPresensi: async (req, res) => {
        const query = "SELECT a.id_presensi, a.id_pegawai, id_opd, b.nama_pegawai, url_foto_pegawai, b.nip_pegawai, a.jam_masuk, a.ket_masuk, a.jam_siang, a.ket_siang, a.jam_pulang, a.ket_pulang, a.edited_by, a.created_at, a.updated_at FROM presensi a JOIN pegawai b WHERE a.id_pegawai = b.id_pegawai"
